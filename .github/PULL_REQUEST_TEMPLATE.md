...
Describe what changed and the agent or operator workflow it improves.

## Security impact

Describe changes to browser isolation, networking, profiles, credentials, file access, untrusted content, or external interfaces. Write “None” when not applicable.
